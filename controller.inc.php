...
require_once './_social_connect/facebook/facebook.inc.php';
require_once './_social_connect/twitter/twitteroauth.php';
require_once './_classes/DatabaseConnection.class.php';
require_once './_classes/Files.class.php';
require_once './_classes/BlogContent.class.php';
require_once './_classes/BlogContentComment.class.php';
require_once './_classes/Displayer.class.php';
require_once './_classes/Social.class.php';
/**
 * Object creation
 */
...
// Content objs
$contents  = new BlogContent( );
$comments  = new BlogContentComment( );
$display   = new Displayer($contents, $comments);
$files     = new Files("./source_codes/");
